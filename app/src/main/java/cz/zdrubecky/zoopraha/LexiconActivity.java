...
public class LexiconActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTaxonomyExpandableListView = (ExpandableListView) findViewById(R.id.activity_lexicon_taxonomy_expandable_listview);
        mTaxonomyExpandableListData = TaxonomyListDataMapper.getData(this);
        mTaxonomyExpandableListTitles = new ArrayList<>(mTaxonomyExpandableListData.keySet());
        mTaxonomyExpandableListAdapter = new TaxonomyExpandableListAdapter(this, mTaxonomyExpandableListTitles, mTaxonomyExpandableListData);
